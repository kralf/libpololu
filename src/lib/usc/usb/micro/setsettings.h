...
#ifndef POLOLU_USC_USB_MICRO_SETSETTINGS_H
#define POLOLU_USC_USB_MICRO_SETSETTINGS_H

/** \brief USB micro servo controller set settings request (USB protocol)
  */
  ...
  namespace Usc {
    namespace Usb {
      namespace Micro {
        ...
        public:
          /** Construct a Pololu USB micro servo controller set
            * settings request
            */
