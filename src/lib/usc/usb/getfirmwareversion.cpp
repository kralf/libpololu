...
Pololu::Usc::Usb::GetFirmwareVersion::GetFirmwareVersion() :
...
Pololu::Device::FirmwareVersion
    Pololu::Usc::Usb::GetFirmwareVersion::getResponse() const {
...
Pololu::Usc::Usb::GetFirmwareVersion*
    Pololu::Usc::Usb::GetFirmwareVersion::clone() const {
  return new GetFirmwareVersion(*this);
}

void Pololu::Usc::Usb::GetFirmwareVersion::write(std::ostream& stream) const {
  stream << getResponse();
}
