...
template <typename T>
Pololu::Serializable<T>::SerializationError::SerializationError() :
  Exception("Error serializing value: %s", Type<T>::getName().c_str()) {
}

template <typename T>
Pololu::Serializable<T>::DeserializationError::DeserializationError() :
  Exception("Error deserializing value: %s", Type<T>::getName().c_str()) {
}

template <typename T>
Pololu::Serializable<T>::Serializable(const T& value) :
  value(value) {
}

template <typename T>
Pololu::Serializable<T>::Serializable(const Serializable<T>& src) :
  value(src.value) {
}
...
template <typename T>
Pololu::Serializable<T>& Pololu::Serializable<T>::operator=(const
    Serializable<T>& src) {
  value = src.value;
  return *this;
}
...
template <typename T>
Pololu::Serializable<T>& Pololu::Serializable<T>::operator=(const T& value) {
  this->value = value;
  return *this;
}
...
void Pololu::Serializable<T>::Traits<U, D>::read(std::istream& stream,
    U& value) {
...
template <typename T>
T& Pololu::Serializable<T>::read(std::istream& stream) {
  Traits<T>::read(stream, value);
  return value;
}

template <typename T>
template <typename U> T& Pololu::Serializable<T>::read(std::istream& stream,
...
template <typename T>
template <typename U, size_t D>
void Pololu::Serializable<T>::Traits<U, D>::write(std::ostream& stream,
    const U& value) {
...
template <typename T>
void Pololu::Serializable<T>::write(std::ostream& stream) const {
  Traits<T>::write(stream, value);
}

template <typename T>
template <typename U> void Pololu::Serializable<T>::write(std::ostream& stream,
...
template <typename T>
Pololu::Serializable<T>::operator T&() {
  return value;
}

template <typename T>
Pololu::Serializable<T>::operator const T&() const {
  return value;
}
